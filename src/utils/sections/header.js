        ...
        return (
                <div className='Section fCol' id="header">
                        ...
                        <ul className='fRow Sub-Menu'>
                                <li><Link to="resume" smooth={true} duration={500} offset={-100} spy={true} className='Sub-link'>Resume</Link></li>
                                <li><Link to="projects" smooth={true} duration={500} offset={-100} spy={true} className='Sub-link'>Projects</Link></li>
