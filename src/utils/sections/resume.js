                                ...
                                <div className='Resumes fCol'>
                                        ...
                                        <ul className='Resumes-obj'>
                                                <li>A Full Stack Software Engineering Certificate at ALX Africa, with a specific focus on back-end technologies as amajor.
                                                         This comprehensive program has provided me with a strong foundation in software development principles and practices, equipping me with the necessary tools to tackle complex challenges.</li>
                                        </ul>
                                </div>
                                <div className='Resumes fCol'>
                                        <div className='fRow Resumes-header'>
                                ...
                                <div className='Resumes fCol'>
                                        ...
                                        <ul className='Resumes-obj'>
                                                <li>I have successfully obtained a high school diploma, 
                                                        providing me with a solid educational foundation and a diverse range of academic skills.</li>
                                        </ul>
                                </div>
                        </div>
                </div>
